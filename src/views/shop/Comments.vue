<template>
  <div v-if="evaluation" class="comment">
    <!-- 商家评分 -->
    <section class="rating-wrap">
      <div class="rating-info">
        <h4>{{evaluation.rating.overall_score.toFixed(1)}}</h4>
    ...
    <div class="shop-info">
      <!-- 分类标签 -->
      <ul class="tags">
        <li v-for="(tag,index) in evaluation.tags" :key="index" :class="{'unsatisfied':tag.unsatisfied}">
          {{tag.name}}
